...
function ExpensePieChart(_a) {
    var totalExpense = _a.totalExpense, totalIncome = _a.totalIncome, totalBalance = _a.totalBalance;
    ...
    return (React.createElement(react_google_charts_1.Chart, { chartType: "PieChart", data: data, options: exports.options, width: "100%", style: { margin: "1rem" } }));
}
