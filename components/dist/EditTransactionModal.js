...
var EditTransactionModal = function (_a) {
  var income = _a.income,
    editIncome = _a.editIncome,
    isEditModalVisible = _a.isEditModalVisible,
    setIsEditModalVisible = _a.setIsEditModalVisible;
  var _b = react_1.useState(income),
    editedIncome = _b[0],
    setEditedIncome = _b[1];
  var _c = react_1.useState(
      dayjs_1["default"](income.createdAt).format("YYYY-MM-DD"),
    ),
    createdAtInput = _c[0],
    setCreatedAtInput = _c[1];
  react_1.useEffect(
    function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch("/api/transaction/" + editedIncome.id, {
                method: "PUT",
          ...
          case 2:
            ...
            editIncome(
              __assign(__assign({}, updatedTransaction), {
    ...
    if (name === "createdAt") {
      ...
      setEditedIncome(function (prev) {
        ...
        return __assign(
          __assign({}, prev),
          ((_a = {}),
          (_a[name] = name === "amount" ? parseInt(value, 10) : value),
          _a),
        );
      });
    }
  ...
  return react_1["default"].createElement(
    ...
    react_1["default"].createElement(
      ...
      react_1["default"].createElement(
        ...
        { id: "edit-transaction-modal-title", variant: "h6", component: "h2" },
      ...
      react_1["default"].createElement(
        material_1.Button,
        { onClick: handleSave, sx: { mt: 2, mb: 1 }, variant: "contained" },
        "Save",
      ),
    ),
  );
